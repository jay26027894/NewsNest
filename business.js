    ...
    const sources = [
      ...
      {
        name: "MediaStack",
        url: `http://api.mediastack.com/v1/news?access_key=2ca49c04bdd30aa9086b1a384d08dd06&categories=business&languages=en&limit=10`,
    ...
    Promise.all(
      ...
      const allNews = results.flat().slice(0, 18); // Limit to 18 articles max
      container.innerHTML = "";
